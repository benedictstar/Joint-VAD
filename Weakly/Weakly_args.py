...
def init_parser(data_dir='data/'):
    ...
    parser.add_argument('--train-gt', default='list/gt-sh-train.npy', help='file of ground truth ')
    ...
    parser.add_argument('--dataset', default='ShanghaiTech', help='dataset to train on (default: )')
    ...
    parser.add_argument('--data_dir', type=str, default=data_dir, help='maximum iteration to train (default: 100)')
...
def init_sub_args(args):
    ...
    args.rgb_list = os.path.join(args.data_dir, 'weakly_'+dataset, args.rgb_list)
    args.test_rgb_list = os.path.join(args.data_dir, 'weakly_'+dataset, args.test_rgb_list)
    args.gt = os.path.join(args.data_dir, 'weakly_'+dataset, args.gt)
    args.train_gt = os.path.join(args.data_dir, 'weakly_'+dataset, args.train_gt)
    return args
