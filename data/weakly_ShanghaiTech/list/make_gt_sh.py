...
root_path = "/mnt/hdd8T/hh/code/Joint-VAD/data/weakly_ShanghaiTech/gt/test_frame_mask"
dirs = os.listdir(root_path)
rgb_list_file ='./data/weakly_ShanghaiTech/list/shanghai-i3d-test-10crop.list'
...
np.save('./data/weakly_ShanghaiTech/list/gt-sh.npy',gt)
